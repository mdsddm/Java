    ...
    public Node flatten(Node head) {
        ...
        while (curr != null) {
            if (curr.child != null) { // flatten it to the next level
                ...
                temp.next = next; //making link with the actual next of curr & last node of the 2nd.3rd & so on level
                if (next != null) next.prev = temp; // if next is null then null.prev will give null pointer exception
